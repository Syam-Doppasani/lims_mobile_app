...
public final class TemplateEditorViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<String> {
  @Override
  public String get() {
    return provide();
  }
  ...
  public static String provide() {
    return Preconditions.checkNotNullFromProvides(TemplateEditorViewModel_HiltModules.KeyModule.provide());
  }
